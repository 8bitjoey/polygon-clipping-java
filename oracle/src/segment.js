...
export default class Segment {
  ...
  split(point) {
    ...
    trace("SPLIT seg=" + this.id + " x=" + bits(point.x) + " y=" + bits(point.y) + " new=" + newSeg.id)
  ...
  consume(other) {
    ...
    trace("CONSUME consumer=" + consumer.id + " consumee=" + consumee.id)
  ...
  isInResult() {
    ...
    trace("INRESULT seg=" + this.id + " val=" + (this._isInResult ? "t" : "f"))
